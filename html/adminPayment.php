...
<div id="wraper">
    ...
    <div class="container">
        ...
        <div class="mainArea subArea">
            ...
            <div class="adminSelectNav">
                <ul class="adminListUl">
                    ...
                    <li class="adminList active"><a href="adminPayment.php">전자결재 관리자</a></li>
                    <li class="adminList"><a href="adminMessage.php">메시징 관리자</a></li>
            ...
            <div class="documentBox m_hide">
                <div class="document_list" style="width:100%">
                    ...
                    <div class="tbBox">
                        <table>
                            <tr>
                                ...
                                <th><a href="javascript:;"><span>전체문서 열람</span></a></th>
                            ...
                            <tr>
                                ...
                                <td>시스템보안R&D팀</td>
                                <td>2022-08-15</td>
                                <td><input type="checkbox" id="허용"><label for="허용">허용</label></td>
                                <td>전체 관리자</td>
                                <td></td>
                            </tr>
                            <tr>
                    ...
                    <div class="tbTotal">관리자 수: <span>7</span></div>
        ...
        <div class="documentBox m_show">
            <ul>
            	<li>
                    <div class="docu_name">김진우 <img src="esign-img/icon_nav06.png"  /> <input type="checkbox" id="checkOk"><label for="checkOk">허용</label> </div>
                    <div class="text">시스템보안R&D팀</div>
                    <div class="date">jwkim / 2022-08-15</div>
                    <div class="states">전체 관리자</div>
                </li>
                <li>
                    <div class="docu_name">박영신 <img src="esign-img/icon_nav06.png"  /> <input type="checkbox" id="checkOk"><label for="checkOk">허용</label></div>
                    <div class="text">개발1본부</div>
                    <div class="date">pys / 2021-05-07</div>
                    <div class="states delete">삭제</div>
                </li>
                <li>
                    <div class="docu_name">박원일 <img src="esign-img/icon_nav06.png"  /> <input type="checkbox" id="checkOk"><label for="checkOk">허용</label></div>
                    <div class="text">CTO</div>
                    <div class="date">jwipark / 2022-08-15</div>
                    <div class="states">전체 관리자</div>
                </li>
                <li>
                    <div class="docu_name">김장운 <img src="esign-img/icon_nav06.png"  /> <input type="checkbox" id="checkOk"><label for="checkOk">허용</label></div>
